...
import { CurrentBookSliceState, CurrentBook } from "../../types/currentBook";
...
export const currentBookSlice = createSlice({
  ...
  reducers: {},
  extraReducers: {
    [fetchCurrentBook.fulfilled.type]: (
      state,
      action: PayloadAction<CurrentBook>
    ) => {
      state.currentBook = action.payload;
      state.isLoading = false;
      state.error = "";
    },
    [fetchCurrentBook.rejected.type]: (
      state,
